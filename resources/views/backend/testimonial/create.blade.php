				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="card">
							...
							<div class="card-body p-4">
								<form class="row g-3" method="POST" action="{{route('backend.testimonial.store')}}" enctype="multipart/form-data">
                                    @csrf
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<input type="text" name="review" class="form-control" id="review" placeholder="Enter Review" required>
                                        @error('review')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
									</div>
									<div class="col-md-6">
										...
										<input type="text" name="rating" class="form-control" id="rating" placeholder="Enter Rating" required>
                                        @error('rating')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
									</div> 
