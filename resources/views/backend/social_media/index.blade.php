				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="{{route('backend.social_media.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New</a></div>
						</div>
									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
												<a href="{{route('backend.social_media.edit', [Crypt::encrypt($social->id)])}}" class=""><i class='bx bxs-edit'></i></a>
												<a href="javascript:;" class="ms-3 delete_btn" data-id="{{$social->id}}"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
									@empty
...
<script>
    $(document).on("click", ".delete_btn", function(){
        console.log('clicked');
        let id = $(this).data("id");
        let url = "{{ route('backend.social_media.destroy')}}";
