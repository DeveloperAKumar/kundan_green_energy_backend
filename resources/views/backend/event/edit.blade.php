...
<div class="col-md-6">
    ...
    <textarea
        ...
        rows="4"
        name="meta_keyword"
        placeholder="Enter Meta Keyword">{{ old('meta_keyword',$event->meta_keyword) }}</textarea>
...
<div class="col-md-6">
    ...
    <textarea
        ...
        placeholder="Enter Meta Description">{{ old('meta_description',$event->meta_description) }}</textarea>
