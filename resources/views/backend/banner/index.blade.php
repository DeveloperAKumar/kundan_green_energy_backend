				...
				<div class="card">
					<div class="card-body">
						<div class="d-lg-flex align-items-center mb-4 gap-3">
						  ...
						  <div class="ms-auto"><a href="{{route('backend.banner.create')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i>Add New Banner</a></div>
						</div>
...
<script>
    $(document).on("click", ".delete_btn", function(){
        console.log('clicked');
        let id = $(this).data("id");
        let url = "{{ route('backend.banner.destroy')}}";
