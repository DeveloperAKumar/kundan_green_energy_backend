        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto">
                        <a href="{{ route('backend.content_gallery.create') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex order-actions">
                                        ...
                                        <a href="{{ route('backend.content_gallery.edit', Crypt::encrypt($gallery->id)) }}">
    ...
    Swal.fire({
        ...
        if(result.isConfirmed){
            ...
            try{
                ...
                const response=await fetch("{{ route('backend.content_gallery.destroy') }}",{
