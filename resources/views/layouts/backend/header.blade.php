...
<html lang="en">
 <head>
	...
	<link href="{{asset('assets/frontend/plugins/highcharts/css/highcharts.css')}}" rel="stylesheet" />
	<link href="{{asset('assets/frontend/plugins/vectormap/jquery-jvectormap-2.0.2.css')}}" rel="stylesheet" />
	...
	<link rel="stylesheet" href="{{asset('assets/frontend/css/semi-dark.css')}}" />
	<link rel="stylesheet" href="{{asset('assets/frontend/css/header-colors.css')}}" />

	<link href="{{asset('assets/frontend/plugins/datatable/css/dataTables.bootstrap5.min.css')}}" rel="stylesheet" />

	<title>Dashboard | {{$site_setting->company_name ?? "" }}</title>
</head>
...
<body>
    ...
    <div>
        <!-- Full Logo -->
        <img src="{{ asset($site_setting->logo_image) }}"
             class="full-logo"
             alt="Logo"
             width="150">

        <!-- Small Logo -->
        <img src="{{ asset($site_setting->favicon) }}"
             class="small-logo"
             alt="Logo"
             width="40">
    </div>
    ...
    <div class="toggle-icon ms-auto">
        <i class='bx bx-first-page'></i>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="{{route('backend.other_page')}}">
						<div class="parent-icon"><i class='bx bx-file'></i>
						</div>
						<div class="menu-title">Other Pages</div>
					</a>
				</li>
				<li>
					<a href="{{route('backend.contact_enquiry')}}">
						<div class="parent-icon"><i class='bx bx-envelope-open'></i>
						</div>
						<div class="menu-title">Contact Enquiry</div>
					</a>
				</li>
				<li>
					<a href="{{route('backend.site_setting.edit')}}">
				...
				<nav class="navbar navbar-expand gap-3">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-message-list">
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-1.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-2.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-3.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-4.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-5.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-6.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-7.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-8.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-9.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-10.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="{{asset('assets/frontend/images/avatars/avatar-11.png')}}" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{asset(Auth::user()->profile_image ?? 'assets/frontend/images/default/default_user.jpg')}}" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="{{route('admin.admin_profile')}}"><i class="bx bx-user"></i><span>Profile</span></a>
							</li>
							<li><a class="dropdown-item" href="{{route('backend.site_setting.edit')}}"><i class="bx bx-cog"></i><span>Site Settings</span></a>
							</li>
							<li><a class="dropdown-item" href="{{route('backend.dashboard')}}"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
							</li>
